export const textBlockResultSectionData: string[] = [
  "For the successful implementation of the repair, it is not enough just a design project and drawings. All this still needs to be implemented efficiently and competently.",
  "Our team not only brings the design idea to life one-on-one with visualization, but also does it clearly on time and without sudden additional expenses.",
